...
@shared_task
def send_scans_used_mail(email):
    send_mail(
        subject="No Scan Credits Remaining",
        message=(
            "Hello Sir!,\n\n"
            "Your subscription has no scan credits remaining.\n"
            "Remaining scans: 0\n\n"
            "Please renew or upgrade your subscription to continue scanning Autodesk drawings.\n\n"
            "Thank you,\n"
            "QR Verifier Team"
        ),
        from_email=DEFAULT_FROM_EMAIL,
